...
### 🟡 v0.4.0b — Реальная баллистика для стрелкового (следующий PR)
**Боеприпасы:**
- [ ] Rifle/Bomb → счётчик патронов/гранат (`config.ini` стартовый запас)
- [ ] Настоящие пули с полётом (не мгновенная 3-клеточная трасса)
...
- [ ] Перезарядка — ручная (`R`) или авто, что при пустом магазине — решить прототипом
...
| **v0.4.0b** | Ranged ballistics | Настоящие пули, боезапас, AmmoPickup, перезарядка |
